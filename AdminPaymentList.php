...
<head>
    ...
    <title>Admin Payment Lists</title>
    <style>
...
<body>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["Date"] . "</td>";
                        echo "<td>";
                        echo "<a href='updatepayment.php?ReferenceNo=" . $row["ReferenceNo"] . "' class='btn btn-primary'>Update</a>";
                        echo "<a href='delete.php?ReferenceNo=" . $row["ReferenceNo"] . "' class='btn btn-danger ml-1'>Delete</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
    ...
    <div class="list">
        <a href="AdminPanel.php" class="list-totable">Back</a>
    </div>
